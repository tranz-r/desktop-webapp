  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 pt-28 lg:pt-32 pb-6">
        <div className="flex flex-col md:flex-row gap-8 h-[calc(100vh-12rem)]">
          ...
          <div className="flex-1 flex flex-col h-[calc(100vh-12rem)]">
            <div className="mb-6">
              <h1 className="text-2xl text-primary-600 font-medium mb-6">Which item do you need to deliver?</h1>
              <SearchCommand 
