  ...
  const handlePostcodeSelect = (selectedPostcode: string) => {
    ...
    setTimeout(() => {
      ...
      const addresses = MOCK_ADDRESSES[selectedPostcode.toUpperCase()] || [
        ...
        `12 Acacia Avenue, London, ${selectedPostcode}`,
        `34 Maple Road, Manchester, ${selectedPostcode}`,
        `56 Oak Street, Birmingham, ${selectedPostcode}`,
        `78 Elm Drive, Liverpool, ${selectedPostcode}`,
        `90 Willow Close, Leeds, ${selectedPostcode}`,
        `101 Sycamore Lane, Bristol, ${selectedPostcode}`,
        `23 Chestnut Grove, Sheffield, ${selectedPostcode}`,
        `45 Poplar Avenue, Newcastle, ${selectedPostcode}`,
        `67 Beech Road, Nottingham, ${selectedPostcode}`,
        `89 Cedar Crescent, Southampton, ${selectedPostcode}`,
        `11 Ashfield Way, Leicester, ${selectedPostcode}`,
        `22 Rowan Street, Coventry, ${selectedPostcode}`,
        `33 Hawthorn Court, Reading, ${selectedPostcode}`,
        `44 Pine Gardens, Derby, ${selectedPostcode}`,
        `55 Birch Avenue, Brighton, ${selectedPostcode}`,
        `66 Larch Lane, Plymouth, ${selectedPostcode}`,
        `77 Spruce Road, Oxford, ${selectedPostcode}`,
        `88 Magnolia Close, Cambridge, ${selectedPostcode}`,
        `99 Hazel Drive, York, ${selectedPostcode}`,
        `100 Holly Avenue, Glasgow, ${selectedPostcode}`,
      ];
