...
export default function EventsMovingPage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <CTASection
        title="Ready to Plan Your Event Move?"
        description="Get your free, no-obligation quote today. Our event moving experts are ready to help you plan a successful event."
