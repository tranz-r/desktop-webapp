  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <Hero
        ...
        badge="Local Residential Moving"
        title="Local Residential Moving Services in Northamptonshire"
        description="Professional, reliable, and affordable local moving services. We handle your move with care, ensuring a stress-free experience from start to finish."
        primaryAction={{
          text: "Get Free Quote",
          href: "/quote-option"
        }}
      ...
      <CTASection
        ...
        description="Get your free, no-obligation quote today. Our team is ready to help you move with confidence and care."
