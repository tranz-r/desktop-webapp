...
export default function LongDistanceMovingPage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <CTASection
        title="Ready to Plan Your Long Distance Move?"
        description="Get your free, no-obligation quote today. Our long-distance moving experts are ready to help you plan a successful relocation across the UK."
