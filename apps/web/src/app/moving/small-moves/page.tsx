...
export default function SmallMovesPage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <CTASection
        title="Ready to Start Your Small Move?"
        description="Get your free, no-obligation quote today. Our small move experts are ready to help you move efficiently and affordably."
