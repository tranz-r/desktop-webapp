...
export default function CommercialMovingPage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <CTASection
        title="Ready to Plan Your Commercial Move?"
        description="Get your free, no-obligation quote today. Our commercial moving experts are ready to help you plan a successful office relocation."
