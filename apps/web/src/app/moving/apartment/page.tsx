...
export default function ApartmentMovingPage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <CTASection
        title="Ready to Move Your Apartment?"
        description="Get your free, no-obligation quote today. Our apartment moving experts are ready to help you move efficiently and safely."
