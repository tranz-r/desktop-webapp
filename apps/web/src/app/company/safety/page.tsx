...
export default function SafetyPage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <CTASection
        title="Experience Safe, Professional Moving"
        description="Choose Tranzr Moves for moving services that prioritize safety, professionalism, and your peace of mind."
